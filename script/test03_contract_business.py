...
from apiTestFramework.api.course import CourseAPI
from apiTestFramework.api.contract import ContractAPI
...
class TestContractBusiness:
    ...
    def test04_add_contract(self):
        # contractNo: 数据唯一
        add_data = {"name": "测试888", "phone": "13612345678", "contractNo": "HT2023003423427", "subject": "6", "courseId": " 99", "channel": "0", "activityId": 77, "fileName": "xxx"}
